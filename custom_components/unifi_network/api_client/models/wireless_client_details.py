...
T = TypeVar("T", bound="WirelessClientDetails")


@_attrs_define
class WirelessClientDetails:
    """
    Attributes:
        type_ (str):
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wireless_client_details.additional_properties = d
        return wireless_client_details
